...
<body data-controller="<?php echo currentRoute('class'); ?>" data-method="<?php echo currentRoute('method'); ?>" class="hold-transition skin-blue sidebar-mini">
	...
	<div class="content-wrapper">
		...
		<section class="content-header">
			<h1>
				Generate's Alternative
			</h1>
			<ol class="breadcrumb">
				<li><i class="fa fa-bolt"></i>&nbsp;Generate's Alternative</li>
				<li class="active">Generate's Alternative</li>
			</ol>
		</section>
				...
				<div class="col-md-12">
					<div class="box box-primary">
			            ...
			            <div class="box-footer">
							<input type="submit" class="btn btn-success pull-left" id="button-save-generate-alternative" value="Process">
			            </div>
			        </div>
			    </div>
			</div>
